    ...
    <div className="opportunity-header-grid">
      <section className="opportunity-header-card">
        <div className="opportunity-header-inner d-flex flex-wrap align-items-start justify-content-between gap-3">
          ...
          <div className="opportunity-header-right d-flex flex-column align-items-end gap-2">
            <span className="d-inline-flex align-items-center px-3 py-1 rounded-pill text-white text-uppercase fw-bold small flex-shrink-0" style={{ fontSize: "0.75rem", background: "#10b981", marginTop: "-0.25rem" }}>Customer</span>
