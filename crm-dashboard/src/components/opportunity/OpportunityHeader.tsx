  ...
  return (
    <div className="opportunity-header-grid">
      <section className="opportunity-header-card">
        <div className="opportunity-header-inner">
          ...
          <div className="d-flex flex-wrap align-items-center justify-content-between gap-2 column-gap-3">
            <p className="fw-semibold text-body mb-0 lh-sm min-w-0" style={{ fontSize: "1.5rem" }}>179484 · John Smith</p>
            <span
              className="d-inline-flex align-items-center px-3 py-1 rounded-pill text-white text-uppercase fw-bold small flex-shrink-0"
              style={{ fontSize: "0.75rem", background: "#10b981" }}
            >
              Customer
            </span>
          </div>
          <p className="text-secondary mt-1 mb-0 small min-w-0">Roof Replacement</p>
          <div className="opportunity-header-actions-gap" aria-hidden="true" />
          <div className="opportunity-header-actions opportunity-header-right d-flex flex-wrap align-items-center justify-content-end gap-2">
            ...
            <button type="button" className="btn d-inline-flex align-items-center gap-2 rounded-pill border bg-white text-body small fw-medium" style={{ padding: "0.5rem 1rem", borderColor: "#e2e8f0" }}>
              <i className="bi bi-envelope text-secondary" style={{ fontSize: "1rem" }} aria-hidden />
              Send Email
            </button>
            <button type="button" className="btn d-inline-flex align-items-center gap-2 rounded-pill border bg-white text-body small fw-medium" style={{ padding: "0.5rem 1rem", borderColor: "#e2e8f0" }}>
              <i className="bi bi-file-earmark-text text-secondary" style={{ fontSize: "1rem" }} aria-hidden />
              Inspection Report
            </button>
          </div>
        </div>
