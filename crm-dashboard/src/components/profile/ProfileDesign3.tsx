...
export default function ProfileDesign3() {
  return (
    <div id="profile-design3" data-profile-panel className="w-100">
      <div className="accordion profile-accordion" id="profileAccordion">
        <div className="accordion-item border rounded-3 overflow-hidden mb-3" style={{ borderColor: "var(--profile-border)" }}>
          <h2 className="accordion-header">
            <button className="accordion-button fw-semibold py-3 px-4 bg-white shadow-none border-0" style={{ color: "var(--profile-text)" }} type="button" data-bs-toggle="collapse" data-bs-target="#profileOverview" aria-expanded="true" aria-controls="profileOverview">
              Profile Overview
            </button>
          </h2>
          <div id="profileOverview" className="accordion-collapse collapse show" data-bs-parent="#profileAccordion">
            <div className="accordion-body p-4 p-lg-5 pt-0 border-top" style={{ borderColor: "var(--profile-border)" }}>
              <div className="d-flex flex-wrap align-items-start gap-4">
                <div className="position-relative flex-shrink-0">
                  <div className="rounded-circle overflow-hidden bg-secondary" style={{ width: 80, height: 80 }}>
                    <img id="profile-avatar-d3" src="https://i.pravatar.cc/150?u=employee" alt="Avatar" className="w-100 h-100 object-fit-cover" />
                  </div>
                  <label className="position-absolute bottom-0 end-0 rounded-2 d-flex align-items-center justify-content-center text-white cursor-pointer shadow-sm" style={{ width: 28, height: 28, background: "var(--profile-primary)" }}>
                    <input type="file" accept="image/*" className="visually-hidden" aria-label="Upload photo" />
                    <i className="bi bi-camera-fill small" />
                  </label>
                </div>
                <div className="min-w-0 flex-grow-1">
                  <h3 className="h5 fw-semibold mb-1" style={{ color: "var(--profile-text)" }}>Alex Johnson</h3>
                  <p className="small mb-0" style={{ color: "var(--profile-text-secondary)" }}>Senior Sales Representative · Sales</p>
                  <p className="small mt-1 mb-0" style={{ color: "var(--profile-text-secondary)" }}>alex.johnson@company.com · (555) 987-6543</p>
                  <div className="mt-3 pt-3 border-top" style={{ borderColor: "var(--profile-border)" }}>
                    <p className="fw-semibold mb-1" style={{ color: "var(--profile-text)", fontSize: "0.875rem" }}>Bio</p>
                    <p className="small mb-0" style={{ color: "var(--profile-text-secondary)", lineHeight: 1.5 }}>Senior sales professional with 8+ years of experience. Passionate about building client relationships and driving growth. Based in San Francisco.</p>
                  </div>
                  <button type="button" className="btn btn-link btn-sm p-0 mt-3 text-decoration-none fw-medium" style={{ color: "var(--profile-primary)" }}>Edit profile</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="accordion-item border rounded-3 overflow-hidden mb-3" style={{ borderColor: "var(--profile-border)" }}>
          <h2 className="accordion-header">
            <button className="accordion-button collapsed fw-semibold py-3 px-4 bg-white shadow-none border-0" style={{ color: "var(--profile-text)" }} type="button" data-bs-toggle="collapse" data-bs-target="#profileBasic3" aria-expanded="false" aria-controls="profileBasic3">
              Basic Information
            </button>
          </h2>
          <div id="profileBasic3" className="accordion-collapse collapse" data-bs-parent="#profileAccordion">
            <div className="accordion-body p-4 p-lg-5 pt-0 border-top" style={{ borderColor: "var(--profile-border)" }}>
              <div className="row g-2 g-md-3">
                ...
                <div className="col-12 col-sm-6 col-md-4"><label className="form-label small mb-0" style={{ color: "var(--profile-text-secondary)" }}>Shirt Size</label><div className="d-flex flex-wrap gap-3 pt-1">{["S", "M", "L", "XL"].map((s) => (<label key={s} className="form-check form-check-inline small"><input type="radio" name="shirt-d3" value={s} className="form-check-input" defaultChecked={s === "M"} /><span className="form-check-label">{s}</span></label>))}</div></div>
              </div>
        ...
        <div className="accordion-item border rounded-3 overflow-hidden mb-3" style={{ borderColor: "var(--profile-border)" }}>
          <h2 className="accordion-header">
            <button className="accordion-button collapsed fw-semibold py-3 px-4 bg-white shadow-none border-0" style={{ color: "var(--profile-text)" }} type="button" data-bs-toggle="collapse" data-bs-target="#profileJob3" aria-expanded="false" aria-controls="profileJob3">
              Job Information
            </button>
          </h2>
          <div id="profileJob3" className="accordion-collapse collapse" data-bs-parent="#profileAccordion">
            <div className="accordion-body p-4 p-lg-5 pt-0 border-top" style={{ borderColor: "var(--profile-border)" }}>
              ...
              <div className="row g-2 g-md-3">
                ...
                <div className="col-12 col-sm-6 col-md-4"><label className="form-label small mb-0" style={{ color: "var(--profile-text-secondary)" }}>Department</label><select disabled className="form-select form-select-sm bg-light" style={{ borderColor: "var(--profile-border)" }}><option>Sales</option></select></div>
        ...
        <div className="accordion-item border rounded-3 overflow-hidden mb-3" style={{ borderColor: "var(--profile-border)" }}>
          <h2 className="accordion-header">
            <button className="accordion-button collapsed fw-semibold py-3 px-4 bg-white shadow-none border-0" style={{ color: "var(--profile-text)" }} type="button" data-bs-toggle="collapse" data-bs-target="#profileAsset3" aria-expanded="false" aria-controls="profileAsset3">
              Asset
            </button>
          </h2>
          <div id="profileAsset3" className="accordion-collapse collapse" data-bs-parent="#profileAccordion">
            <div className="accordion-body p-4 p-lg-5 pt-0 border-top" style={{ borderColor: "var(--profile-border)" }}>
              <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                ...
                <button type="button" className="btn btn-primary-saas" data-bs-toggle="modal" data-bs-target="#profileAssetModal3">
              ...
              <div className="modal fade" id="profileAssetModal3" tabIndex={-1} aria-labelledby="profileAssetModal3Label" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                  <div className="modal-content" style={{ borderColor: "var(--profile-border)" }}>
                    <div className="modal-header border-bottom" style={{ borderColor: "var(--profile-border)" }}>
                      <h5 className="modal-title fw-semibold small" id="profileAssetModal3Label" style={{ color: "var(--profile-text)" }}>Add Asset</h5>
        ...
        <div className="accordion-item border rounded-3 overflow-hidden mb-3" style={{ borderColor: "var(--profile-border)" }}>
          <h2 className="accordion-header">
            <button className="accordion-button collapsed fw-semibold py-3 px-4 bg-white shadow-none border-0" style={{ color: "var(--profile-text)" }} type="button" data-bs-toggle="collapse" data-bs-target="#profileDocument3" aria-expanded="false" aria-controls="profileDocument3">
              Document
            </button>
          </h2>
          <div id="profileDocument3" className="accordion-collapse collapse" data-bs-parent="#profileAccordion">
            <div className="accordion-body p-4 p-lg-5 pt-0 border-top" style={{ borderColor: "var(--profile-border)" }}>
              <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
